...
document.body.appendChild(ba);var n,ca,u,x,z,A,da,H,I,ea,L,fa=0,ha=0,na="",M,N,R=[],S="#fff #f0f #ff0 #0ff #0f0 #fa0".split(" "),oa=(c.height-64)/4,T=new Uint8Array(128),pa=new Uint8Array(1024);navigator.mediaDevices.getUserMedia({audio:!0}).then(function(d){ea=d;c.onmousedown();N=new MediaRecorder(d);N.ondataavailable=function(d){R[A].b.src=URL.createObjectURL(d.data);n=M.currentTime-L;R[A].b.currentTime=.1+n+R[A].of;R[A].b.play();A=0}});for(var U=0;6>U;++U)R[U]={},R[U].of=0,0<U&&(R[U].b=new Audio);
