...
32,r-4*e,0,g+32,r-4*e,32);l.addColorStop(0,"rgba(255,255,191,0)");l.addColorStop(1,"rgba(255,255,191,1)");a.fillStyle=l;a.beginPath();a.moveTo(g,r);a.quadraticCurveTo(g+32,r-32-8*e,g+64,r-16-8*e);a.fill();t(0);t(1/3);t(2/3)}fa++;984<d-ha&&(na=fa+"fps",ha=d,fa=0);a.fillStyle="#fff";a.fillText(na+(u?" stop":""),1,12);requestAnimationFrame(Sa)};